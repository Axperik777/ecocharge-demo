...
(() => {
  ...
  const groups = [{id:'single',name:'Single',count:1},{id:'network',name:'Network',count:3},{id:'portfolio',name:'Portfolio',count:5},{id:'scale',name:'Scale',count:10}];
  ...
  const documents={
    summary:`<div class="ec-dialog-body"><span class="ec-kicker">DOCUMENT PREVIEW</span><h2 id="site-dialog-title">Sample participation summary</h2><p>A readable example of the plan information. This is not a signed contract or proof of an investment.</p><article class="ec-document-paper"><header><b>ECO CHARGE</b><span>ILLUSTRATIVE SAMPLE</span></header><h3>Participation summary</h3><dl><div><dt>Client</dt><dd>Sample client</dd></div><div><dt>Demo allocation</dt><dd>Set inside the account</dd></div><div><dt>Selected model</dt><dd>Chosen inside the account</dd></div><div><dt>Weekly assumption</dt><dd>Defined by the selected group</dd></div><div><dt>One-week illustration</dt><dd>Amount × selected weekly rate</dd></div><div><dt>Additional per-car credit</dt><dd>None</dd></div><div><dt>Withdrawal schedule</dt><dd>Every 4 days after plan activation or the last successful withdrawal</dd></div></dl><p><b>Proposed model.</b> Driver payments are the proposed source of company revenue. The company’s 43% participation figure is an unverified assumption with no confirmed network scope.</p><p><b>Pending terms.</b> Legal issuer, ownership evidence, eligibility, fees, withdrawal rules, client rights and risk disclosures require verified documentation. The weekly rate is not supported by operating data in this demo.</p><footer>SAMPLE ONLY · NO SIGNATURE · NO REAL TRANSACTION</footer></article><div class="ec-dialog-actions"><button class="ec-button" id="print-summary">Print sample / save as PDF ${arrow}</button><a class="ec-text-link" href="register/?next=documents">Explore account documents ${arrow}</a></div></div>`,
    ownership:`<div class="ec-dialog-body"><span class="ec-kicker">DOCUMENTS NOT YET PROVIDED</span><h2 id="site-dialog-title">Company & ownership verification</h2><p>Before considering a real investment, request documents that connect the legal issuer to the specific business and assets.</p><ul class="ec-review-list"><li>Registered company name, registration number, jurisdiction and authorized representatives.</li><li>The exact network and assets covered by the proposed 43% interest.</li><li>Ownership and participation records showing what the company owns and what rights a client receives.</li><li>Evidence connecting financial reports to the stated network.</li><li>Final offering documents and investor eligibility requirements.</li></ul><div class="ec-dialog-note">Public directory listings, station photos and the ECO CHARGE brand do not establish ownership, endorsement or an investment right.</div></div>`,
